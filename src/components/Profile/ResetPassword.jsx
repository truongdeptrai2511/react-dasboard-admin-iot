  ...
  return (
    <form className="form-reset-pass" onSubmit={handleSubmit}>
      ...
      <input
        ...
        className="form-reset-pass-inp"
      />
      {errors.oldPassword && <div className="error_msg">{errors.oldPassword}</div>}
      {errors.newPassword && <div className="error_msg">{errors.newPassword}</div>}
      {errors.retypeNewPassword && (
        <div className="error_msg">{errors.retypeNewPassword}</div>
      )}
